import type {SerializedVector2, SignalValue, SimpleSignal} from '@flammable7841/core';
import {BBox, DEG2RAD} from '@flammable7841/core';
 ...
 * import {makeScene2D, Circle} from '@flammable7841/2d';
 *
 ...
 * import {makeScene2D, Circle} from '@flammable7841/2d';
 * import {all, createRef, easeInCubic, easeOutCubic} from '@flammable7841/core';
 *
 * export default makeScene2D(function* (view) {
 *   const ref = createRef<Circle>();
 *   view.add(
